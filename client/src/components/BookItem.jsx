...
function BookItem({ book }) {
  ...
  return (
    <div className="book-item border-black border-2 text-white font-saira w-[12rem] px-4 py-2 flex flex-col justify-center items-center">
      ...
      <button
        ...
        className="bg-green-400 mt-2 hover:bg-blue-400 text-richBlue-100 font-saira text-base font-bold p-1 px-4 rounded-full w-fit"
      >
        Borrow
      </button>{" "}
